...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v0.38.0 // indirect
	...
	go.opentelemetry.io/otel/exporters/stdout/stdoutmetric v0.38.0 // indirect
